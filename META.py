...
def banner():
    os.system('clear')
    # বামের ছবির মতো একদম ক্লিন এবং মাঝখানে থাকা ৫ কালারের META ব্যানার
    print(f"""
{R}          ███╗   ███╗███████╗████████╗ █████╗ 
{G}          ████╗ ████║██╔════╝╚══██╔══╝██╔══██╗
{Y}          ██╔████╔██║█████╗     ██║   ███████║
...
def main():
    banner()
    # প্রথম পিকের মতো [•] চিহ্নগুলো লাল এবং বাকি লেখা সবুজ
    ...
    # তীর চিহ্ন [▼] লাল করা হয়েছে আপনার নির্দেশ অনুযায়ী
