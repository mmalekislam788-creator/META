...
def banner():
    os.system('clear')
    # একদম স্টেটকাট এবং শ্যাডো-মুক্ত সলিড META ব্যানার
    # ডবল লাইন বা শ্যাডো হওয়ার কোনো সুযোগ নেই
    print(f"""
{R}          ███    ███  ███████  ████████  █████  
{G}          ████  ████  ██          ██    ██   ██ 
{Y}          ██ ████ ██  █████       ██    ███████ 
...
{P}          """)
    ...
    # আপনার নির্দেশমতো বর্ডার এবং তথ্য
    line = f"{G}×××××××××××××××××××××××××××××××××××××××××××××××××{W}"
    print(line)
...
def main():
    banner()
    # পিকের মতো [•] এবং [▼] লাল, বাকি সব সবুজ
...
def cloning_start():
    ...
    for i in range(limit):
        ...
        # আপনার কার্যকর সেই মেটা কুকি এপিআই
