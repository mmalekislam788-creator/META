...
def cloning_start():
    ...
    for i in range(limit):
        ...
        # ১. পাসওয়ার্ড এখন ৬ সংখ্যার করা হয়েছে (uid[4:] ব্যবহার করে)
        pws = uid[4:] 
        
        # আপনার এপিআই লজিক অপরিবর্তিত
        ...
        # আউটপুট: সবুজ কালার এবং [🌺] ইমোজি ঠিক রাখা হয়েছে
        print(f'{G}[MALEK-OK💚] {uid} • {pws} xxx') 
        print(f'{G}[🌺] COOKIE = datr={datr};sb={sb};c_user={uid};xs={xs};fr={fr};m_page_voice={uid}\n')
        
        # প্রতি ২ সেকেন্ড পর পর ফলাফল দেখাবে
        time.sleep(2.0)

    # ২. নিচের মডেল স্টাইল আপনার লিখে দেওয়া ফরম্যাটে ঠিক করা হয়েছে
    print(f'{G}[/{uid} • {pws}]')
