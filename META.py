...
def banner():
    os.system('clear')
    # বামের ছবির মতো একদম ক্লিন, মাঝখানে থাকা এবং শ্যাডো-মুক্ত ৫ কালারের META ব্যানার
    print(f"""
{R}          ███╗   ███╗███████╗████████╗ █████╗ 
{G}          ████╗ ████║██╔════╝╚══██╔══╝██╔══██╗
{Y}          ██╔████╔██║█████╗     ██║   ███████║
...
{P}          ╚═╝     ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═╝""")
    ...
    # আপনার নির্দেশমতো ডানদিকে সামান্য বাড়ানো সবুজ বর্ডার
    line = f"{G}×××××××××××××××××××××××××××××××××××××××××××××××××{W}"
    print(line)
...
def main():
    banner()
    # প্রথম পিকের মতো [•] এবং [▼] লাল, বাকি লেখা সবুজ
