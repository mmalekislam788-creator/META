...
def banner():
    os.system('clear')
    # META লোগো মাঝামাঝি রাখার জন্য স্পেস অ্যাডজাস্ট করা হয়েছে
    print(f"""
{R}                ███    ███  ███████  ████████  █████  
{G}                ████  ████  ██          ██    ██   ██ 
{Y}                ██ ████ ██  █████       ██    ███████ 
...
def cloning_start():
    ...
    print(f'{G}×××××××××××××××××××××××××××××××××××××××××××××××××{W}')
    # আপনার চাওয়া অনুযায়ী কালারফুল সংখ্যা
    print(f'{R}[•] {G}EXAMPLE : [ {Y}500{G}, {O}1000{G}, {G}100000 {G}]{W}')
    print(f'{G}×××××××××××××××××××××××××××××××××××××××××××××××××{W}')
    ...
    for i in range(limit):
        ...
        # আপনার নির্দেশমতো [MALEK-RUNNING] বাদ দিয়ে মিটার সেট করা হয়েছে
    ...
    # [ BACK ] এর জায়গায় আপনার চাওয়া রেজাল্ট ফরম্যাট
    print(f'{G}      {limit}/{limit} [OK:{ok}]')
    print(f'×××××××××××××××××××××××××××××××××××××××××××××××××{W}')
    input(f'\n{G} [ BACK ]{W}')
    main()
