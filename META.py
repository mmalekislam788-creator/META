...
# রঙ সেটআপ যা একদম অরিজিনাল টুলের মতো দেখাবে
R = '\033[1;31m' # Red
G = '\033[1;32m' # Green
Y = '\033[1;33m' # Yellow
B = '\033[1;34m' # Blue
...
def banner():
    os.system('clear')
    # আপনার পিকের মতো সেই মাল্টিকালার ব্যানার স্টাইল
    print(f"""{R}███╗   ███╗███████╗████████╗ █████╗ 
{Y}████╗ ████║██╔════╝╚══██╔══╝██╔══██╗
{G}██╔████╔██║█████╗     ██║   ███████║
{B}██║╚██╔╝██║██╔══╝     ██║   ██╔══██║
...
def main():
    banner()
    print(f'{R}[•] SALAMU ALAIKUM............')
    print(f'{G}×××××××××××××××××××××××××××××××××××××××××××××')
    print(f'{R}[•] CYBER STRIKER TEAM.........')
    print(f'{G}×××××××××××××××××××××××××××××××××××××××××××××')
...
def cloning_start():
    ...
    for i in range(limit):
        # রিয়েলিস্টিক আইডি ও পাসওয়ার্ড জেনারেশন
        uid = f"{code}{random.randint(1111111, 9999999)}"
        pws = uid[5:] # উদাহরন পাসওয়ার্ড
        
        # আপনার দেওয়া সেই স্পেশাল কুকি ফরম্যাট
